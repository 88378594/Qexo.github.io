	...
	<div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-body">
          <form action="./lahei.php" method="post" class="form-horizontal" role="form">
			...
			<div class="form-group">
              ...
              <select name="type" class="form-control">
			    ...
			    <option value="ＱＱ冻结">ＱＱ冻结</option>
				<option value="请关闭设备锁">请关闭设备锁</option>
              </select>
              </div>
            </div>
